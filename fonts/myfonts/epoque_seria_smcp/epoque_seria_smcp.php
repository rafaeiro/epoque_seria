...
/*
Plugin Name: epoque_seria_smcp #320153
...
add_action( 'admin_init', array('MyFontsInstaller_320153','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_320153','myfonts_loadupWebfonts' ));
