...
/*
Plugin Name: epoque_seria_black #799263
...
add_action( 'admin_init', array('MyFontsInstaller_799263','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_799263','myfonts_loadupWebfonts' ));
