...
/*
Plugin Name: epoque_seria #939592
...
add_action( 'admin_init', array('MyFontsInstaller_939592','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_939592','myfonts_loadupWebfonts' ));
